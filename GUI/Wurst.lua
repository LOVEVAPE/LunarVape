...
function mainapi:CreateCategory(categorysettings)
  ...
  function categoryapi:CreateModule(modulesettings)
    ...
    description.Text = 'Type: Hack, Category: '
      .. moduleapi.Category
      .. '\n\nDescription:\n'
    ...
    function moduleapi:Expand()
      ...
      tween:Tween(
        ...
        { Size = moduleholder.Visible and UDim2.new(0, 924, 1, -306) or UDim2.new() }
      )
...
for _, v in { 'Combat', 'Blatant', 'Render', 'Utility', 'World', 'Lunar Vape' } do
